...
\para{Closest Pair kann deterministisch in $O(n \log n)$ Zeit gelöscht werden. (devide \& conquer) %TODO komplexität richtig?
...
\para{$X$ sein eine Zufallsvariable. Der Erwartungswert einer diskreten Zufallsvariable ist $E(X)=\sum\limits_i \cdot Pr(x=i)$}
