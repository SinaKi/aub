...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2.5cm,
    ...
    \node[main node] (1) {vw};
    \node[main node] (4) [below left = 1cm and 0.5cm of 1,minimum size=0.3cm] {};
    \node[main node] (5) [above left = 1cm and 0.5cm of 1,minimum size=0.3cm] {};
    \node[main node] (4) [below right = 1cm and 0.5cm of 1,minimum size=0.3cm] {};
    \node[main node] (6) [above right = 1cm and 0.5cm of 1,minimum size=0.3cm] {};
    \node[main node] (6) [left = 1cm of 1,minimum size=0.3cm] {};
    \node[main node] (4) [below right = 0.4cm and 1cm of 1.2,minimum size=0.3cm] {};
    \node[main node] (6) [above right = 0.4cm and 1cm of 1.2,minimum size=0.3cm] {};
    
\end{tikzpicture}
\end{figure}
%TODO kanten (mehrfachkanten)
%TODO graphen nebeneinander
...
\paragraph*{Annahme:} Es gibt genau einen MonCut und dessen Wert ist $K$.
