\paragraph*{} Interpretiere jeden Anlauf, den Algorithmus berechnen zu lassen als einen Münzwurf mit
\begin{itemize}
...
\paragraph*{} $G_1$ und $G_2$ sind isomorph zueinander, falls eine Bijektion $\varphi : V_1 \rightarrow V_2$ existiert, sodass $\forall (u,v) \in E_1 \Leftrightarrow (\varphi(u),\varphi(v)) \in E_2$
