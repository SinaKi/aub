\minisec{} Interpretiere jeden Anlauf, den Algorithmus berechnen zu lassen als einen Münzwurf mit
\begin{itemize}
...
\minisec{} $G_1$ und $G_2$ sind isomorph zueinander, falls eine Bijektion $\varphi : V_1 \rightarrow V_2$ existiert, sodass $\forall (u,v) \in E_1 \Leftrightarrow (\varphi(u),\varphi(v)) \in E_2$
...
\minisec{} Bislang gibt es keinen Polynomzeitalgorithmus, der Graphisomorphie entscheidet. NP-Harte ist nicht bekannt.
...
\minisec{} Alice permutiert $G_j$ (mit $j \in \{ 1,2 \}$ zufällig) mit einer zufälligen Permutation $\Pi$ zu $H$ (und stellt sicher, dass $H \not= G_1,G_2$) und schickt $H$ zu Bob.
